...
/* package webscrapper-0.1.0.0 */
#ifndef VERSION_webscrapper
#define VERSION_webscrapper "0.1.0.0"
#endif /* VERSION_webscrapper */
#ifndef MIN_VERSION_webscrapper
#define MIN_VERSION_webscrapper(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_webscrapper */
...
/* package liquid-containers-0.6.4.1 */
#ifndef VERSION_liquid_containers
#define VERSION_liquid_containers "0.6.4.1"
...
#define CURRENT_COMPONENT_ID "webscrapper-0.1.0.0-inplace-SAT_solver"
